...
class SearchPresenter(
    ...
    fun searchCocktails(
        ...
        executor.execute {
            try {
                ...
                // MERGED: Sort results by search priority (left to right matching) from upstream
    ...
    // MERGED: Keep advanced sorting functionality from upstream for better search results
